"""FastAPI application entry point for the ELAW backend."""
...
from elaw_server.config import get_config_dir, load_config
from elaw_server.models import HandshakeMessage, HandshakePayload
from elaw_server.persona.loader import list_personas, load_persona
from elaw_server.session.manager import SessionManager
from elaw_server.theme_manager import delete_theme, get_theme, list_themes, save_theme
from elaw_server.websocket.connection import WSConnection
from elaw_server.websocket.handler import MessageHandler
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title="ELAW Server", version="0.1.0")
