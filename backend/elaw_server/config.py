"""Configuration loading for ELAW server."""
...
def load_config(config_dir: str | Path | None = None) -> ELAWConfig:
    ...
    return ELAWConfig(**data)


def get_config_dir() -> Path:
    return Path(os.environ.get("ELAW_CONFIG_DIR", DEFAULT_CONFIG_DIR))
